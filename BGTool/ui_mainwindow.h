...
**
** Created: Thu Jul 22 23:50:53 2010
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(332, 387);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(MainWindow->sizePolicy().hasHeightForWidth());
        MainWindow->setSizePolicy(sizePolicy);
        MainWindow->setMinimumSize(QSize(332, 387));
        MainWindow->setMaximumSize(QSize(332, 387));
        ...
        widget->setGeometry(QRect(0, 0, 331, 341));
        ...
        visualizationView = new VisualizationGraphicsView(widget);
        ...
        spritesView = new MouseGraphicsView(widget);
        ...
        btConvert = new QPushButton(widget);
        ...
        btPaint = new QToolButton(widget);
        ...
        selectedView = new QGraphicsView(widget);
